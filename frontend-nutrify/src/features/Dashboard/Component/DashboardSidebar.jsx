...
function DashboardSidebar() {
  return (
    <aside className="relative flex h-screen w-[260px] flex-col overflow-hidden bg-gradient-to-b from-[#04A16E] to-[#036245] px-5 py-7">
      
      {/* BIG CIRCLE */}
      <div className="absolute -left-[150px] bottom-80 h-[300px] w-[300px] rounded-full border border-white/20" />

      {/* SMALL CIRCLE */}
      <div className="absolute left-[-95px] bottom-95 h-[180px] w-[180px] rounded-full border border-white/10" />
      ...
      <nav className="relative z-10 flex flex-col gap-6">
        ...
        {/* ACTIVE MENU */}
        <button className="flex h-[46px] items-center gap-3 rounded-[12px] bg-[#F4F4F4] px-5 text-[#69AF96] shadow-[0_2px_10px_rgba(0,0,0,0.15)] transition-all duration-200">
